...
var TaskService = (function () {
    ...
    TaskService.prototype.deleteTask = function (no) {
        return this.http.delete('http://localhost:3000/api/task/' + no).map(function (res) { return res.json(); });
    };
    TaskService.prototype.updateTask = function (updtask) {
        var headers = new http_1.Headers();
        headers.append('Content-Type', 'application/json');
